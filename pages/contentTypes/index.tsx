...
const ContentTypes: NextPage = () => {
  ...
  const init = async (): Promise<void> => {
    ...
    const ct = await contract.get_content_types()
    setContentTypes(ct)
    setLoading(false)
  }
  ...
  //   setLoading(true)
  //   contract.delete_content_type({ name: ct.name }).then(() => {
  ...
  return (
    <Layout home={false}>
      <h1 className="text-center text-6xl font-normal leading-normal mt-0 mb-5">Content Types</h1>
